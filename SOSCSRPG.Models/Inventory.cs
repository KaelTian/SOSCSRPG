...
namespace SOSCSRPG.Models
{
    public class Inventory
    {
        ...
        //public Inventory AddItemFromFactory(int itemTypeID)
        //{
        //    return AddItems(new List<GameItem> { ItemFactory.CreateGameItem(itemTypeID) });
        //}
        public Inventory AddItems(IEnumerable<GameItem> items)
        {
            return new Inventory(Items.Concat(items));
        }
        //public Inventory AddItems(IEnumerable<ItemQuantity> itemQuantities)
        //{
